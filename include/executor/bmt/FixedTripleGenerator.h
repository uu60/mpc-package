...
private:
    ...
    static const std::array<std::tuple<std::pair<uint8_t, uint8_t>, std::pair<uint8_t, uint8_t>, std::pair<uint8_t, uint8_t>>, 100> TRIPLES_8;

    static const std::array<std::tuple<std::pair<uint16_t, uint16_t>, std::pair<uint16_t, uint16_t>, std::pair<uint16_t, uint16_t>>, 100> TRIPLES_16;

    static const std::array<std::tuple<std::pair<uint32_t, uint32_t>, std::pair<uint32_t, uint32_t>, std::pair<uint32_t, uint32_t>>, 100> TRIPLES_32;
